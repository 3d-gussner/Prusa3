...
module x_end_holes()
{
    ...
    // Bottom pushfit rod
    translate([-15, -41.5, 6]) rotate(a=[-90, 0, 0]) pushfit_rod(8.1, 50);

    // Top pushfit rod
    translate([-15, -41.5, rod_distance+6]) rotate(a=[-90, 0, 0]) pushfit_rod(8.1, 50);
}
...
module pushfit_rod(diameter,length)
{
    ...
    // translate([0,-diameter/2-2,length/2]) cube([diameter,1,length], center=true);
}
