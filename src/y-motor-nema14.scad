...
module y_motor_base(){
 ...
 translate(v = [29,-21+50,0]){
  translate(v = [-21+4.5,-2.5,5]) cube(size = [9,26,10], center=true);
  translate(v = [-15.5,-15.5,0]) cylinder(h = 10, r=5.5);
  translate(v = [-15.5,+10.5,0]) cylinder(h = 10, r=5.5);
...
module y_motor_holes(){
 translate(v = [29,-21+50,0]){
  ...
  translate(v = [-15.5,+10.5,-1]) cylinder(h = 10, r=1.7);
  // Screw holes
  translate(v = [-15.5,-15.5,7]) cylinder(h = 7, r=3.5);
  translate(v = [-15.5,+10.5,7]) cylinder(h = 7, r=3.5);
 }
